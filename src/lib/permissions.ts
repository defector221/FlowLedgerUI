...
const ROLE_PERMISSIONS: Record<RoleCode, string[]> = {
  ORGANIZATION_ADMIN: ['*'],
  ACCOUNTANT: ['sales:read', 'sales:write', 'purchases:read', 'payments:read', 'payments:write', 'reports:read', 'customers:read', 'suppliers:read', 'products:read'],
  SALES_MANAGER: ['sales:read', 'sales:write', 'customers:read', 'customers:write', 'products:read', 'payments:read', 'payments:write'],
  PURCHASE_MANAGER: ['purchases:read', 'purchases:write', 'suppliers:read', 'suppliers:write', 'products:read', 'payments:read', 'payments:write'],
  INVENTORY_MANAGER: ['inventory:read', 'inventory:write', 'products:read', 'products:write', 'warehouses:read', 'warehouses:write', 'categories:read', 'categories:write'],
  VIEWER: ['sales:read', 'purchases:read', 'inventory:read', 'customers:read', 'suppliers:read', 'products:read', 'reports:read', 'payments:read'],
}
